...
class DecisionTree:
        ...
        for current_node in list(self.tree_nodes.values()):
            if current_node.node_type == 'criterion':
                ...
                self.tree_graph.node(str(current_node.node_nr), '''<<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="1">
                                                                <TR>
                                                                    <TD><FONT POINT-SIZE="10.0" COLOR="azure">'''+ str(self.get_target_distribution(current_node.node_nr).tolist()) +'''</FONT></TD>
                                                                </TR>
    ...
    def export(self, filename):
        ...
        for n in self.tree_nodes.values():
            ...
            node_info = str(n.node_nr) + ';' + str(n.node_label) + ';' + str(n.node_type) + ';' + str(split_info)
        ...
        self.data.to_csv(filename+'.csv', sep=';')
